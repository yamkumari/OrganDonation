...
<nav class="menu">
	...
	<div class="register">
		...
		<form method="post" id="register" action="receiver.php" autocomplete="off">
			...
			<select id="blood_group" name="blood_group"required>
					...
					<br>
					<br>
					<label>Organs i want to receive:</label><br>
					<br>
                    
                     <select id="blood_group" name="organ"required>
			    	<option>Choose</option>
			    	<option>Liver</option>
			    	<option>Heart</option>
...
$sql = " INSERT INTO `receivers`( `Firstname`, `Lastname`, `Age`, `Blood Group`, `Organ`, `Gender`, `Mobile No.`, `Email`, `City`, `State`, `Country`) VALUES ('$fname','$lname','$Age','$blood_group','$organ','$gender','$number','$email','$yourcity','$yourstate','$yourcountry')";
